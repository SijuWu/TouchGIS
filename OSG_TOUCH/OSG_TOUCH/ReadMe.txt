========================================================================
    APPLICATION WIN32 : Vue d'ensemble du projet OSG_TOUCH
========================================================================

AppWizard a créé cette application OSG_TOUCH pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application OSG_TOUCH.
...
small.ico
    ...
    ressources principal OSG_TOUCH.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé OSG_TOUCH.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
